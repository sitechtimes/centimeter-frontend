    ...
    <div class="container mx-auto px-4 py-12 max-w-2xl">
      <div class="space-y-8">
        <div class="text-center space-y-4">
          ...
          <p class="text-xl text-[var(--text-color)] opacity-80">Session Code: <span class="font-semibold">{{ sessionCode }}</span></p>
        ...
        <div v-if="!hasJoined" class="space-y-6 mt-12">
          <div>
            <label for="nickname" class="block text-lg font-semibold text-[var(--text-color)] mb-3">
              Enter your nickname
            </label>
            <input
              id="nickname"
