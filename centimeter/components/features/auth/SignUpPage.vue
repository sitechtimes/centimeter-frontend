    ...
    <div class="flex items-center justify-center flex-col bg-[color:var(--bg-color)] p-4 rounded-3xl mb-4 overlay-parent w-full max-w-md">
      ...
      <form class="login flex items-center justify-center flex-col gap-7 w-full" @submit.prevent="signupWithEmail">
        <div class="relative flex items-start justify-center flex-col gap-1">
          ...
          <input
            v-model="email"
            class="w-96 h-12 rounded-lg border-0 px-4 transition duration-500 focus:outline-2 text-[color:var(--text-color)] bg-[color:var(--faded-bg-color)] outline-[color:var(--primary)]"
            id="email"
            type="email"
            required
          />
      ...
      <span class="mb-4 mt-2 text-[color:var(--text-color)]"
        >By signing up, you accept our <a href="/" class="underline text-[color:var(--secondary)]">terms of use</a> and
        <a href="/" class="underline text-[color:var(--secondary)]">privacy policy.</a></span
      >
