<template>
  <div class="w-full max-w-5xl mx-auto p-6 space-y-1">
    <div v-for="presentation in presentations" :key="presentation.presentation_name" class="flex items-center gap-4 py-3 px-2 rounded-lg hover:bg-[color:var(--secondary-shade)] transition-colors">
