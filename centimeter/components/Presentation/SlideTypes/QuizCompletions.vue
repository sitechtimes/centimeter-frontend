<template>
  <div>
    ...
    <div class="grid grid-cols-2 gap-3">
      <button v-for="option in quizOptions" :key="option.label" class="flex items-center gap-1 p-3 rounded-lg hover:bg-[var(--faded-bg-color)] transition-all text-left" @click="handleClick(option)">
