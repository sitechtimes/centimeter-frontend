<template>
    <div v-if="!slideLabel(slideOption)" class="h-screen flex items-start justify-center bg-[#efefef] p-6 pt-12">
        <div
            role="region"
    ...
    <div v-if="slideLabel('Multiple Choice')">
...
const slideLabel = (slideOption:string) => {
    const isChosenAction = ref(slideOption !== "")
    return isChosenAction
}
