    ...
    <div class="flex items-center justify-center flex-col bg-[color:var(--bg-color)] p-4 rounded-3xl mb-4 overlay-parent w-full max-w-md">
            ...
            <form class="login flex items-center justify-center flex-col gap-7 w-full" @submit.prevent="signupWithEmail">
                <div class="relative flex items-start justify-center flex-col gap-1">
                    ...
                    <input v-model="email" class="w-96 h-12 rounded-lg border-0 px-4 transition duration-500 focus:outline-2 bg-[color:var(--faded-bg-color)] outline-[color:var(--primary)]" id="email" type="email" required />
                ...
                <div class="relative flex items-start justify-center flex-col gap-1">
                    ...
                    <input v-model="name" class="w-96 h-12 rounded-lg border-0 px-4 transition duration-500 focus:outline-2 bg-[color:var(--faded-bg-color)] outline-[color:var(--primary)]" id="name" type="text" required autocomplete="name" />
                ...
                <div class="relative flex items-start justify-center flex-col gap-1">
                    ...
                    <input v-model="password" class="w-96 h-12 rounded-lg border-0 px-4 transition duration-500 focus:outline-2 bg-[color:var(--faded-bg-color)] outline-[color:var(--primary)]" id="password" type="password" required autocomplete="new-password" />
                ...
                <div class="relative flex items-start justify-center flex-col gap-1">
                    ...
                    <input v-model="confirmPassword" class="w-96 h-12 rounded-lg border-0 px-4 transition duration-500 focus:outline-2 bg-[color:var(--faded-bg-color)] outline-[color:var(--primary)]" id="confirm" type="password" required autocomplete="new-password" />
